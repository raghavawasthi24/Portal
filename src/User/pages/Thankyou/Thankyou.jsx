...
const Thankyou = () => {
  return (
   ...
   <Container className="ThankMain"> 
   <Box className="ThankImg">
       <img style={{width:"25rem",height:"25rem"}}src="src\User\assets\CSI LOGO.svg"/>
  </Box>
  <p className="ThankHead">Thankyou for coming to CINE 2023</p>
...
<p style={{paddingLeft:"0.5rem"}}>Copyrights by Computer Society of India</p>
  </Box>                                                                  
   </Container>
